...
fs.readFile(__dirname + "/public/data/" + "adresses.json", 'utf8', function (err, data) {
   ...
   return trace + '</table>';
	...
	let chaine = '<table style="border:4px solid #2f4591;background-color:#4f6ab3;color:white;height:400px;width:600px;margin:auto;font-family:arial;">' + '<CAPTION style="color:#2f4591">Exercice 4 - Tableau des Membres</CAPTION>';
